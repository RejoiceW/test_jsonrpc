...
class TestArbitrumGoerli(JsonrpcApi):
    ...
    @pytest.mark.parametrize('data', [datas['arbitrum_goerli']])
    def test_eth_chainId(self, env, data):
        result = self.eth_chainId(env['arbitrum_goerli'], **data['eth_chainId']['payload'])  # 解构
    ...
    def test_eth_syncing(self, env, data):
        result = self.eth_syncing(env['arbitrum_goerli'], **data['eth_syncing']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBlockByNumber(self, env, data):
        result = self.eth_getBlockByNumber(env['arbitrum_goerli'], **data['eth_getBlockByNumber']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBlockByHash(self, env, data):
        result = self.eth_getBlockByHash(env['arbitrum_goerli'], **data['eth_getBlockByHash']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_blockNumber(self, env, data):
        result = self.eth_blockNumber(env['arbitrum_goerli'], **data['eth_blockNumber']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_gasPrice(self, env, data):
        result = self.eth_gasPrice(env['arbitrum_goerli'], **data['eth_gasPrice']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBalance(self, env, data):
        result = self.eth_getBalance(env['arbitrum_goerli'], **data['eth_getBalance']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getTransactionByHash(self, env, data):
        result = self.eth_getTransactionByHash(env['arbitrum_goerli'], **data['eth_getTransactionByHash']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getTransactionByBlockHashAndIndex(self, env, data):
        result = self.eth_getTransactionByBlockHashAndIndex(env['arbitrum_goerli'],
    ...
    def test_eth_getTransactionByBlockNumberAndIndex(self, env, data):
        result = self.eth_getTransactionByBlockNumberAndIndex(env['arbitrum_goerli'],
    ...
    def test_eth_getTransactionReceipt(self, env, data):
        result = self.eth_getTransactionReceipt(env['arbitrum_goerli'], **data['eth_getTransactionReceipt']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getTransactionCount(self, env, data):
        result = self.eth_getTransactionCount(env['arbitrum_goerli'], **data['eth_getTransactionCount']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBlockTransactionCountByHash(self, env, data):
        result = self.eth_getBlockTransactionCountByHash(env['arbitrum_goerli'],
    ...
    def test_eth_getBlockTransactionCountByNumber(self, env, data):
        result = self.eth_getBlockTransactionCountByNumber(env['arbitrum_goerli'],
    ...
    def test_eth_getLogs(self, env, data):
        result = self.eth_getLogs(env['arbitrum_goerli'], **data['eth_getLogs']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getCode(self, env, data):
        result = self.eth_getCode(env['arbitrum_goerli'], **data['eth_getCode']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_call(self, env, data):
        result = self.eth_call(env['arbitrum_goerli'], **data['eth_call']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getStorageAt(self, env, data):
        result = self.eth_getStorageAt(env['arbitrum_goerli'], **data['eth_getStorageAt']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_estimateGas(self, env, data):
        result = self.eth_estimateGas(env['arbitrum_goerli'], **data['eth_estimateGas']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_newFilter(self, env, data):
        result = self.eth_newFilter(env['arbitrum_goerli'], **data['eth_newFilter']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_newBlockFilter(self, env, data):
        result = self.eth_newBlockFilter(env['arbitrum_goerli'], **data['eth_newBlockFilter']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_newPendingTransactionFilter(self, env, data):
        result = self.eth_newPendingTransactionFilter(env['arbitrum_goerli'], **data['eth_newPendingTransactionFilter']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getFilterChanges(self, env, data):
        result = self.eth_getFilterChanges(env['arbitrum_goerli'], **data['eth_getFilterChanges']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_net_version(self, env, data):
        result = self.net_version(env['arbitrum_goerli'], **data['net_version']['payload'])
        Utils.assert_response_status(result)
    ...
    #     result = self.net_listening(env['arbitrum_goerli'], **data['net_listening']['payload'])
    #     Utils.assert_response_status(result)
    ...
    #     result = self.net_peerCount(env['arbitrum_goerli'], **data['net_peerCount']['payload'])
    #     Utils.assert_response_status(result)
    ...
    def test_web3_clientVersion(self, env, data):
        result = self.web3_clientVersion(env['arbitrum_goerli'], **data['web3_clientVersion']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_web3_sha3(self, env, data):
        result = self.web3_sha3(env['arbitrum_goerli'], **data['web3_sha3']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_txpool_status(self, env, data):
        result = self.txpool_status(env['arbitrum_goerli'], **data['txpool_status']['payload'])
        Utils.assert_response_status(result)
