...
@pytest.mark.linea_mainnet
class TestLineaMainnet(JsonrpcApi):
    """通过调用不同的业务，来完成相关测试"""
    ...
    @pytest.mark.parametrize('data', [datas['linea_mainnet']])
    def test_eth_chainId(self, env, data):
        result = self.eth_chainId(env['linea_mainnet'], **data['eth_chainId']['payload'])  # 解构
    ...
    def test_eth_syncing(self, env, data):
        result = self.eth_syncing(env['linea_mainnet'], **data['eth_syncing']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBlockByNumber(self, env, data):
        result = self.eth_getBlockByNumber(env['linea_mainnet'], **data['eth_getBlockByNumber']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBlockByHash(self, env, data):
        result = self.eth_getBlockByHash(env['linea_mainnet'], **data['eth_getBlockByHash']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_blockNumber(self, env, data):
        result = self.eth_blockNumber(env['linea_mainnet'], **data['eth_blockNumber']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_gasPrice(self, env, data):
        result = self.eth_gasPrice(env['linea_mainnet'], **data['eth_gasPrice']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBalance(self, env, data):
        result = self.eth_getBalance(env['linea_mainnet'], **data['eth_getBalance']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getTransactionByHash(self, env, data):
        result = self.eth_getTransactionByHash(env['linea_mainnet'], **data['eth_getTransactionByHash']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getTransactionByBlockHashAndIndex(self, env, data):
        result = self.eth_getTransactionByBlockHashAndIndex(env['linea_mainnet'],
    ...
    def test_eth_getTransactionByBlockNumberAndIndex(self, env, data):
        result = self.eth_getTransactionByBlockNumberAndIndex(env['linea_mainnet'],
    ...
    def test_eth_getTransactionReceipt(self, env, data):
        result = self.eth_getTransactionReceipt(env['linea_mainnet'], **data['eth_getTransactionReceipt']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getTransactionCount(self, env, data):
        result = self.eth_getTransactionCount(env['linea_mainnet'], **data['eth_getTransactionCount']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBlockTransactionCountByHash(self, env, data):
        result = self.eth_getBlockTransactionCountByHash(env['linea_mainnet'],
    ...
    def test_eth_getBlockTransactionCountByNumber(self, env, data):
        result = self.eth_getBlockTransactionCountByNumber(env['linea_mainnet'],
    ...
    def test_eth_getLogs(self, env, data):
        result = self.eth_getLogs(env['linea_mainnet'], **data['eth_getLogs']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getCode(self, env, data):
        result = self.eth_getCode(env['linea_mainnet'], **data['eth_getCode']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_call(self, env, data):
        result = self.eth_call(env['linea_mainnet'], **data['eth_call']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getStorageAt(self, env, data):
        result = self.eth_getStorageAt(env['linea_mainnet'], **data['eth_getStorageAt']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_estimateGas(self, env, data):
        result = self.eth_estimateGas(env['linea_mainnet'], **data['eth_estimateGas']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_newFilter(self, env, data):
        result = self.eth_newFilter(env['linea_mainnet'], **data['eth_newFilter']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_newBlockFilter(self, env, data):
        result = self.eth_newBlockFilter(env['linea_mainnet'], **data['eth_newBlockFilter']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_newPendingTransactionFilter(self, env, data):
        result = self.eth_newPendingTransactionFilter(env['linea_mainnet'], **data['eth_newPendingTransactionFilter']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getFilterChanges(self, env, data):
        result = self.eth_getFilterChanges(env['linea_mainnet'], **data['eth_getFilterChanges']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_net_version(self, env, data):
        result = self.net_version(env['linea_mainnet'], **data['net_version']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_net_listening(self, env, data):
        result = self.net_listening(env['linea_mainnet'], **data['net_listening']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_net_peerCount(self, env, data):
        result = self.net_peerCount(env['linea_mainnet'], **data['net_peerCount']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_web3_clientVersion(self, env, data):
        result = self.web3_clientVersion(env['linea_mainnet'], **data['web3_clientVersion']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_web3_sha3(self, env, data):
        result = self.web3_sha3(env['linea_mainnet'], **data['web3_sha3']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_txpool_status(self, env, data):
        result = self.txpool_status(env['linea_mainnet'], **data['txpool_status']['payload'])
        Utils.assert_response_status(result)
