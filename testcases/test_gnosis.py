...
@pytest.mark.gnosis
class TestGnosis(JsonrpcApi):
    """通过调用不同的业务，来完成相关测试"""

    @allure.feature('eth_chainId')
    @allure.story('返回当前配置的链id')
    @pytest.mark.parametrize('data', [datas['gnosis']])
    def test_eth_chainId(self, env, data):
        result = self.eth_chainId(env['gnosis'], **data['eth_chainId']['payload'])  # 解构
    ...
    def test_eth_syncing(self, env, data):
        result = self.eth_syncing(env['gnosis'], **data['eth_syncing']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBlockByNumber(self, env, data):
        result = self.eth_getBlockByNumber(env['gnosis'], **data['eth_getBlockByNumber']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBlockByHash(self, env, data):
        result = self.eth_getBlockByHash(env['gnosis'], **data['eth_getBlockByHash']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBlockReceipts(self, env, data):
        result = self.eth_getBlockReceipts(env['gnosis'], **data['eth_getBlockReceipts']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_blockNumber(self, env, data):
        result = self.eth_blockNumber(env['gnosis'], **data['eth_blockNumber']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_gasPrice(self, env, data):
        result = self.eth_gasPrice(env['gnosis'], **data['eth_gasPrice']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBalance(self, env, data):
        result = self.eth_getBalance(env['gnosis'], **data['eth_getBalance']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getTransactionByHash(self, env, data):
        result = self.eth_getTransactionByHash(env['gnosis'], **data['eth_getTransactionByHash']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getTransactionByBlockHashAndIndex(self, env, data):
        result = self.eth_getTransactionByBlockHashAndIndex(env['gnosis'],
    ...
    def test_eth_getTransactionByBlockNumberAndIndex(self, env, data):
        result = self.eth_getTransactionByBlockNumberAndIndex(env['gnosis'],
    ...
    def test_eth_getTransactionReceipt(self, env, data):
        result = self.eth_getTransactionReceipt(env['gnosis'], **data['eth_getTransactionReceipt']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getTransactionCount(self, env, data):
        result = self.eth_getTransactionCount(env['gnosis'], **data['eth_getTransactionCount']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getBlockTransactionCountByHash(self, env, data):
        result = self.eth_getBlockTransactionCountByHash(env['gnosis'],
    ...
    def test_eth_getBlockTransactionCountByNumber(self, env, data):
        result = self.eth_getBlockTransactionCountByNumber(env['gnosis'],
    ...
    def test_eth_getLogs(self, env, data):
        result = self.eth_getLogs(env['gnosis'], **data['eth_getLogs']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getCode(self, env, data):
        result = self.eth_getCode(env['gnosis'], **data['eth_getCode']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_call(self, env, data):
        result = self.eth_call(env['gnosis'], **data['eth_call']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getStorageAt(self, env, data):
        result = self.eth_getStorageAt(env['gnosis'], **data['eth_getStorageAt']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_estimateGas(self, env, data):
        result = self.eth_estimateGas(env['gnosis'], **data['eth_estimateGas']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_newFilter(self, env, data):
        result = self.eth_newFilter(env['gnosis'], **data['eth_newFilter']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_newBlockFilter(self, env, data):
        result = self.eth_newBlockFilter(env['gnosis'], **data['eth_newBlockFilter']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_newPendingTransactionFilter(self, env, data):
        result = self.eth_newPendingTransactionFilter(env['gnosis'], **data['eth_newPendingTransactionFilter']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_eth_getFilterChanges(self, env, data):
        result = self.eth_getFilterChanges(env['gnosis'], **data['eth_getFilterChanges']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_net_version(self, env, data):
        result = self.net_version(env['gnosis'], **data['net_version']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_net_listening(self, env, data):
        result = self.net_listening(env['gnosis'], **data['net_listening']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_net_peerCount(self, env, data):
        result = self.net_peerCount(env['gnosis'], **data['net_peerCount']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_web3_clientVersion(self, env, data):
        result = self.web3_clientVersion(env['gnosis'], **data['web3_clientVersion']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_web3_sha3(self, env, data):
        result = self.web3_sha3(env['gnosis'], **data['web3_sha3']['payload'])
        Utils.assert_response_status(result)
    ...
    def test_txpool_status(self, env, data):
        result = self.txpool_status(env['gnosis'], **data['txpool_status']['payload'])
        Utils.assert_response_status(result)
